...
<footer class="footer">
  <div class="footer-container container">
    <ul class="footer-links">
      ...
      <li class="footer-links-item">
        <a data-lng="footer-reception-points" href="../map.php" class="footer-links-item-link">Пункти прийому одноразок</a>
      </li>
      <li class="footer-links-item">
		<a data-lng="footer-public-offer" href="../public-offer.php" class="footer-links-item-link">Публічна оферта </a>
      </li>
    </ul>
  </div>
</footer>
